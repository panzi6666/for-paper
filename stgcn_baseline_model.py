...
def create_stgcn_baseline_model(num_class=2, pretrained_path=None):
    model = STGCN_Baseline_Net(
        num_class=num_class,
        num_point=18,
        num_person=1,
        in_channels=3,
