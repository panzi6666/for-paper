...
from stgcn_nocbam_model import create_stgcn_nocbam_psta_model
...
def main():
    parser = argparse.ArgumentParser(description='训练ST-GCN+PSTA（无CBAM）深蹲力竭预测模型')
    ...
    parser.add_argument('--save_dir', type=str, default='models/stgcn_nocbam_results', 
                        help='保存结果的目录')
    ...
    model = create_stgcn_nocbam_psta_model(
        num_class=2,
