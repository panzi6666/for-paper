...
from stgcn_baseline_model import create_stgcn_baseline_model
...
def main():
    parser = argparse.ArgumentParser(description='训练ST-GCN Baseline深蹲力竭预测模型')
    ...
    parser.add_argument('--save_dir', type=str, default='models/stgcn_baseline_results', 
                        help='保存结果的目录')
    ...
    model = create_stgcn_baseline_model(
        num_class=2,
